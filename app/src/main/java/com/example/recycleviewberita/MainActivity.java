...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listBerita.add(new BeritaModel("Juara Coding itu mantap, ini kata nining","Lifestyle","https://lms.juaracoding.com/pluginfile.php/1/theme_lambda/slide1image/1648385307/foto0.jpg"));
